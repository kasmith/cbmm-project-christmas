...
Experiment.prototype.run = function(me) {
    me.badtrial = false;
    me.trial.runtrial(.025,20,function () {me.recordTrial(me);});
};
...
Experiment.prototype.recordTrial = function(me) {
    ...
    me.pt.recordTrialData([trname,me.tridx,goalsw,resps,sc,realgoal,me.badtrial]);
...
Experiment.prototype.instructions = function() {
    ...
    runS1 = function() {
        ...
        that2.trial.runtrial(.025,20,function () {
            if (that2.badtrial) {
