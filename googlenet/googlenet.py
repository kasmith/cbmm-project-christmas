...
NUM_CHANNELS = 3
NUM_FRAMES = 2
TRAIN_SET = '/home/ubuntu/drive/frames_b1-5_t10k_f2_s2.h5'
...
# Building 'GoogLeNet'
def build_googlenet():
    network = input_data(shape=[None, IMAGE_SIZE, IMAGE_SIZE, NUM_CHANNELS * NUM_FRAMES])
    ...
    # CHANGED STRIDE FROM 2 TO 1. TODO Check if this is OK, try other alternatives
    pool4_3_3 = max_pool_2d(inception_4e_output, kernel_size=3, strides=1, name='pool_3_3')
